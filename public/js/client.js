...
// Example MiroTalk JavaScript code (add to an appropriate file)

// Add this to your MiroTalk client's JavaScript code

const socket = new WebSocket("ws://localhost:8765");

socket.binaryType = "arraybuffer"; // Receive raw audio data
